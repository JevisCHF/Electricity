# -*- coding: utf-8 -*-
import scrapy
from Scrapy_yyjxh_V1_01.items import ScrapyYyjxhV101Item
import time
...
class YyjxhV1Spider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        for num in range(200, 493):
            next_link = f'http://www.yyjxh.com/huodian/huodianhuanbao/list17{num}.html'
            cate = '行业资讯'
