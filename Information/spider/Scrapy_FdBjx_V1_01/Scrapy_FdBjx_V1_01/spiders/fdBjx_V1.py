# -*- coding: utf-8 -*-
import scrapy
from Scrapy_FdBjx_V1_01.items import ScrapyFdbjxV101Item
import time
from scrapy.utils import request
from Scrapy_FdBjx_V1_01.start_urls import urls


class FdbjxV1Spider(scrapy.Spider):
    name = 'fdBjx_V1'
    ...
    def parse(self, response):
        ...
        if next_page1:
            next_url = f'http://fd.bjx.com.cn{next_page1}'
            print(next_url)
            yield scrapy.Request(url=next_url, callback=self.parse, meta={'cate': cate})
        elif next_page2:
            next_url = f'http://fd.bjx.com.cn{next_page2}'
            print(next_url)
            yield scrapy.Request(url=next_url, callback=self.parse, meta={'cate': cate})
...
if __name__ == '__main__':
    ...
    cmdline.execute(['scrapy', 'crawl', 'fdBjx_V1'])