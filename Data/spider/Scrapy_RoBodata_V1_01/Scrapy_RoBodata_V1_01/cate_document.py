...
class CateFileSpider(scrapy.Spider):
    ...
    def parse1(self, response):
        ...
        for info in config_info["data"]["childData"]:
            ...
            if hasChildren:
                ...
                yield scrapy.Request(url=url, callback=self.parse2, dont_filter=True, meta={'num': num, 'cate': cate})
            else:
    ...
    def parse2(self, response):
        ...
        for info in config_info["data"]["childData"]:
            ...
            if hasChildren:
                url = self.base_urls + id
                # yield scrapy.Request(url=url, callback=self.parse3, dont_filter=True, meta={'num': num, 'cate': cate})
